...
//        Forecast currentForecast = new Forecast(weatherObj);
    ...
    private void getForecastWeatherIcon(int day, String description){
        ...
        if(description.contains("Clear")){
            String file = "jaweather/src/main/resources/javaweathers/pics/sun_75x60_5ForecastView.jpg";
            setForecastWeatherIcon(file, day);
        }
        else if(description.contains("few clouds")){
            String file = "jaweather/src/main/resources/javaweathers/pics/partCloudy_75x60_5ForecastView.png";
            setForecastWeatherIcon(file, day);
        }
            ...
            String file = "jaweather/src/main/resources/javaweathers/pics/clouds_75x60_5ForecastView.png";
            setForecastWeatherIcon(file, day);
        }
        else if(description.contains("Rain")){
            String file = "jaweather/src/main/resources/javaweathers/pics/rain_75x60_5ForecastView.png";
            setForecastWeatherIcon(file, day);
        }
    }
